<template>
    <div>
        ...
        <!-- <div ref="container" style="min-height: 400px; width: 100%; background: green; padding: 5px;" ></div> -->
        <div ref="container" style="min-height: 400px; width: 100%; background: green; "></div>
